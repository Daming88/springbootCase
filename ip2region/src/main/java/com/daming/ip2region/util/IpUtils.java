package com.daming.ip2region.util;
...
public class IpUtils {
    ...
    public static String getIp2region(String ip)  {
        ...
        try {
            ...
            // 截取到最后一个 | 之前的部分
            ipInfo = removeLastPartAndAllPipes(ipInfo);
    ...
    public static String removeLastPartAndAllPipes(String input) {
        // 找到最后一个 | 的位置
        ...
        // 截取到最后一个 | 之前的部分
        String truncatedString = input.substring(0, lastPipeIndex);

        // 替换所有 |
        String result = truncatedString.replace("|", " ");
